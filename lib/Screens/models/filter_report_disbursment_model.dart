class FilterReportDisbursmentModel {
  String id;
  String debitur;
  String nomorAkad;
  String plafond;
  ...
  factory FilterReportDisbursmentModel.fromJson(Map<String, dynamic> json) =>
      FilterReportDisbursmentModel(
        id: json['id'],
        ...
        nominal_os_akhir: json['nominal_os_akhir'],
        cabang: json['cabang'],
