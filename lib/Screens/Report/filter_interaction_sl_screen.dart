...
import 'package:leadsgo_apps/Screens/Report/filter_interaction_sl.dart';

import '../../constants.dart';

class FilterInteractionSlScreen extends StatefulWidget {
  String nik;

  FilterInteractionSlScreen(this.nik);
  @override
  _FilterInteractionSlScreenState createState() => _FilterInteractionSlScreenState();
}

class _FilterInteractionSlScreenState extends State<FilterInteractionSlScreen> {
        ...
        onPressed: () {
          ...
          if (formKey.currentState.validate()) {
            ...
            Navigator.pushReplacement(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        FilterInteractionSlReportScreen(widget.nik, tanggalAwal, tanggalAkhir)));
          }
        },
        child: Text(
          'Cari',
