...
class _DisbursmentAddNewScreen extends State<DisbursmentAddNewScreen> {
  ...
  Future saveDisbursment() async {
    ...
    //server save api
    var url = Uri.parse(
        'https://tetranabasainovasi.com/api_marsit_v1/service.php/saveDisbursmentNew');
    ...
    var response = await http.post(url, body: {
      ...
      'nomor_rekening': widget.nomorRekening,
      ...
      'kode_ao': widget.kodeAOPetugasBank,
    ...
    if (response.statusCode == 200) {
      ...
      } else if (message.toString() == 'Nomor Rekening') {
        setState(() {
          visible = false;
        });
        Toast.show(
                                ...
                                if (formKey.currentState.validate()) {
                                  if (image1 == null) {
                                    _scaffoldKey.currentState
                                      ...
                                      content: Text(
                                          'Mohon pilih foto bukti dana cair...'),
                        ...
                        child: Column(
                          children: <Widget>[
                            Column(
                              children: <Widget>[
                                fieldDebitur(
                                    'Tanggal Akad', widget.tanggalAkadX, 120),
                                SizedBox(
                                  height: 10,
                                ),
                                fieldDebitur(
                                    'No. Rekening', widget.nomorRekening, 120),
                                SizedBox(
                                  height: 10,
                                ),
                                fieldDebitur('No. Perjanjian',
                                ...
                                // fieldDebitur('Informasi Sales', widget.selectedJenisInfo, 120),
                              ],
                            ),
                          ],
                        ),
                        ...
                        child: Column(
                          children: <Widget>[
                            Column(
                              children: <Widget>[
                                fieldDebitur(
                                    'Kode AO', widget.kodeAOPetugasBank, 120),
                                SizedBox(
                                  height: 10,
                                ),
                                fieldDebitur(
                    ...
                    Container(
                      ...
                      child: FlatButton(
                        ...
                        child: Container(
                          child: Center(
                            child: Text(
                              re_send == false ? 'Simpan' : 'Simpan Kembali',
