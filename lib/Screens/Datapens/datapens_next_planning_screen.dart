...
class DatapensNextPlanningScreen extends StatefulWidget {
  String username;
  String niksales;
  List<String> notas;
  List<String> nama;
  ...
  DatapensNextPlanningScreen(
      this.username, this.niksales, this.notas, this.nama, this.tglInteraksi);
  @override
  _DatapensNextPlanningScreenState createState() => _DatapensNextPlanningScreenState();
}

class _DatapensNextPlanningScreenState extends State<DatapensNextPlanningScreen> {
  String notasnya = '';
